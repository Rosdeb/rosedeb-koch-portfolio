...
Services available on Wuffoos`,
  ...
  },
  {
    ...
    description: "Koko App is an iOS device-control project for managing connected hardware from one place, including light control, volume adjustment, alarms, screen lock, sleep timers, Wi-Fi FTP file-system transfer, classic media playback, and BLE-based device communication.",
    websiteLink: "https://kokocreates.com/",
    screenshots: [
      {
        src: "/koko_1.jpeg",
  ...
  },
  {
    ...
    name: "Wellbyn",
    year: "June 2025",
    tags: ["Flutter", "WebSocket", "Node.js", "Firebase", "Real-time", "Doctor Patient Communication"],
    description: "Healthcare management platform that enables patients to book appointments, receive medication reminders, securely store medical records, manage insurance, and automatically reschedule appointments while helping doctors streamline patient care.",
    websiteLink: "#",
  },
  {
    id: "9",
  ...
  },
  {
    ...
    description: "The Mom App helps busy moms reclaim time, reduce stress, and stay organized effortlessly — all from one AI-powered hub. Whether you’re juggling work, kids, calendars, meals, chores, reminders, passwords, or grocery lists, this app helps you organize and share the load.",
    playStoreLink: "https://play.google.com/store/apps/details?id=com.momapp.family",
    appStoreLink: "https://apps.apple.com/app/id6756739178",
    websiteLink: "https://themom.app/",
  },
  {
    id: "11",
    index: "11",
    ...
    description: "Ayudame Service Provider helps service professionals manage bookings, connect with customers, track jobs, and grow their business efficiently. Providers can receive service requests, update job status, communicate with customers, and manage earnings from a single app.",
    appStoreLink: "https://apps.apple.com/us/app/ayudame/id6772288218",
  ...
  },
  {
    ...
    name: "Titra",
    year: "March 2026",
    tags: ["Flutter", "WebRTC-audio-video call", "Real-time Communication"],
    description: "Titra is mobile based on webrtc-audio or video call platfrom for end to end communication whith real time based on app unique 10 digit number",
    websiteLink: "#",
  },
]
